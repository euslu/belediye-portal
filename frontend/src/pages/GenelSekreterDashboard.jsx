      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "20px 16px 40px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 14 }}>
          <Card title="👥 Personel">
            ...
            <StatRow label="Aktif"   value={personel.aktif.toLocaleString("tr-TR")} bg="#f0fdf4" color={C.primaryDark} />
            <StatRow label="İzinli"  value={personel.izinli}  bg="#fffbeb" color="#d97706" />
            <StatRow label="Görevde" value={personel.gorevde} bg="#eff6ff" color={C.info} />
